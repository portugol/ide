...
(function () {
            ...
            if (u) u.initstatus = i, u.start = new Date - u.ms * i;
                ...
                for (var B in o) if (o[k](B) && (ee[k](B) || n.paper.customAttributes[k](B))) switch (x[B] = n.attr(B), null == x[B] && (x[B] = te[B]), v[B] = o[B], ee[B]) {
                            ...
                            case "transform":
                                var P = n._,
                                    I = ze(P[B], v[B]);
                                if (I) for (x[B] = I.from, v[B] = I.to, m[B] = [], m[B].real = !0, _ = 0, w = x[B].length; w > _; _++) for (m[B][_] = [x[B][_][0]], L = 1, A = x[B][_].length; A > L; L++) m[B][_][L] = (v[B][_][L] - x[B][_][L]) / g;
                                else {
    ...
    t.color = function (e) {
        ...
        return t.is(e, N) && t.is(e[0], N) && (i = Ce(e)), i.length || E(e).replace(ae, function (t, e, n) {
            ...
            else for (; a.length >= r[s] && (i.push([e][T](a.splice(0, r[s]))), r[s]););
    ...
    var Se = t.pathBBox = function (t) {
        ...
        return n.bbox = e(v), v
            ...
            if (t.is(e, N) && t.is(e && e[0], N) || (e = t.parsePathString(e)), !e || !e.length) return [["M", 0, 0]];
            var r = [],
                i = 0,
                s = 0,
                o = 0,
                            ...
                            for (var v in l) if (l[k](v)) {
                                    switch (ee[v]) {
                                        ...
                                        case "path":
                                            ...
                                            break;
                                        case "transform":
                                            if (h[v].real) for (i = [], m = 0, y = l[v].length; y > m; m++) for (i[m] = [l[v][m][0]], b = 1, _ = l[v][m].length; _ > b; b++) i[m][b] = l[v][m][b] + g * o * h[v][m][b];
                                            else {
                                                var w = function (t) {
    ...
    cn.attr = function (e, n) {
        if (e && t.is(e, N) && t.is(e[0], "object")) for (var r = 0, i = e.length; i > r; r++) this.items[r].attr(e[r]);
        else for (var a = 0, s = this.items.length; s > a; a++) this.items[a].attr(e, n);
        return this
    }, cn.clear = function () {
        ...
        if (this.fonts[n] ? this.fonts[n].push(e) : this.fonts[n] = [e], !t.svg) {
            ...
            for (var i in t.glyphs) if (t.glyphs[k](i)) {
                    ...
                    }, a.k) for (var s in a.k) a[k](s) && (e.glyphs[i].k[s] = a.k[s])
                }
        }
        return t
    ...
    var v = function (n, i) {
        ...
        C = function (n, a) {
            if ("text" == n.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
                ...
                } else for (f = o.getElementsByTagName("tspan"), p = 0, d = f.length; d > p; p++) p ? v(f[p], {
                            dy: u * k,
                            x: s.x
                        }) : v(f[0], {
                            dy: 0
